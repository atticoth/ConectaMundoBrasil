        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.imageRow}>
            <TouchableOpacity onPress={() => handleImagePress("imagem1")}>
              <Image
                source={require("../assets/images/arco_foto1.jpg")}
          ...
          <View style={styles.imageRow}>
            ...
            <TouchableOpacity onPress={() => handleImagePress("imagem5")}>
              <Image
                source={require("../assets/images/padroeiro_bom_jesus.jpg")}
                style={[styles.image, styles.imageWithBorder]}
                resizeMode="cover"
              />
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => handleImagePress("imagem6")}>
              <Image
                source={require("../assets/images/pacifico_cavalcante_1.jpeg")}
                style={[styles.image, styles.imageWithBorder]}
                resizeMode="cover"
              />
            </TouchableOpacity>
