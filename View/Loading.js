...
export function Loading({ navigation }) {
  ...
  return (  
    <View style={styles.container}>
      <ImageBackground source={require('../assets/images/loading_screen_secundary.jpg')} style={styles.backgroundImage} resizeMode="cover">
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start' }}>
        <Image source={require('../assets/images/loading_screen_secundary.jpg')} style={styles.image} resizeMode="stretch" />
      </View>
