...
export function TouristAttraction5({ navigation }) {
    return (
        <LinearGradient
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    <View style={styles.content}>
                        ...
                        <View style={styles.imageContainer}>
                            <Image source={require('../../assets/images/galeriaConectaAi/5/imagem2.jpg')} style={styles.imageLarge} resizeMode="cover" />
                        </View>
...
export default TouristAttraction5;
