...
export function TouristAttraction6({ navigation }) {
    return (
        <LinearGradient
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    <View style={styles.content}>
                        ...
                        <View style={styles.imageContainer}>
                            <Image source={require('../../assets/images/galeriaConectaAi/6/imagem1.jpg')} style={styles.imageLarge} resizeMode="cover" />
                        </View>
...
export default TouristAttraction6;
