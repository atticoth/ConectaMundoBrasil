...
export function DetailsScreenAguaBoa({ navigation }) {
  const handleImagePress = (imageName) => {
    ...
    switch (imageName) {
      case "imagem1":
        screenName = "ParqueIpesTourism";
        break;
      case "imagem2":
        screenName = "PracaLazerTourism";
        break;
      case "imagem3":
        screenName = "ParoquiaTourism";
        break;
      case "imagem4":
        screenName = "LagoaBuritisTourism";
        break;
      case "imagem5":
        screenName = "PracaCulturaTourism";
        break;
      default:
        ...
        <View style={styles.imageContainer}>
          <View style={styles.imageRow}>
            <TouchableOpacity onPress={() => handleImagePress("imagem1")}>
              <Image
                source={require("../assets/images/galeria/ipes/ipes2.jpg")}
                style={[
                  styles.image,
          ...
          >
            <TouchableOpacity onPress={() => handleImagePress("imagem2")}>
              <Image
                source={require("../assets/images/galeria/lazer/lazer4.jpg")}
                style={[
                  styles.image,
                  styles.imageWithBorder,
            ...
            <TouchableOpacity onPress={() => handleImagePress("imagem3")}>
              <Image
                source={require("../assets/images/galeria/paroquia/igreja2.jpg")}
                style={[
                  styles.image,
                  styles.imageWithBorder,
                  { marginHorizontal: Dimensions.get("window").width * 0.01 },
            ...
            <TouchableOpacity onPress={() => handleImagePress("imagem4")}>
              <Image
                source={require("../assets/images/galeria/buritis/buritis2.jpg")}
                style={[
                  styles.image,
                  styles.imageWithBorder,
                  { marginHorizontal: Dimensions.get("window").width * 0.01 },
          ...
          <View style={styles.imageRow}>
            <TouchableOpacity onPress={() => handleImagePress("imagem5")}>
              <Image
                source={require("../assets/images/galeria/cultura/CEL06419.jpg")}
                style={[
                  styles.image,
                  styles.imageWithBorder,
                  { marginHorizontal: Dimensions.get("window").width * 0.020 },
...
export default DetailsScreenAguaBoa;
