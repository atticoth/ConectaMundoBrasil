...
export function LoadingScreenConectaMundoBrasil({ navigation }) {
  useEffect(() => {
    setTimeout(() => {
      navigation.navigate('TourismDetailsScreenConectaMundoBrasil');
    }, 4000);
  }, []);
...
export default LoadingScreenConectaMundoBrasil;
