...
const images = {
  imagem1: require("../../assets/images/galeria/currais/arco_foto1.jpg"),

  // imagem5: require("../assets/images/pracadagloria.jpg"),

  // imagem9: require("../assets/images/pracadagloria.jpg"),

  imagem2: require("../../assets/images/galeria/currais/nossa_senhora_da_luz.jpg"),

  imagem3: require("../../assets/images/galeria/currais/pacifico_cavalcante_1.jpeg"),

  imagem4: require("../../assets/images/galeria/currais/padroeiro_bom_jesus.jpg"),
};
...
export const AtracoesCurrais = ({ navigation }) => {
  ...
  const renderImages = () => {
    const sections = [
      ...
      // { title: "Mirante do Baixão do Caldeirão", key: "imagem2" },
      // { title: "Passagem Molhada do Pará", key: "imagem3" },
      { title: "Nossa Senhora Aparecida da Luz", key: "imagem2" },
      { title: "Padroeiro Bom Jesus da Lapa", key: "imagem4" },
      { title: "Pacífico Cavalcante", key: "imagem3" },
    ];
